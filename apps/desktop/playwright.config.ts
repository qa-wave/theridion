...
export default defineConfig({
  ...
  webServer: [
    {
      command: `cd ../sidecar && THERIDION_PORT=${TEST_SIDECAR_PORT} THERIDION_HOME=${TEST_HOME} uv run python -m theridion_sidecar.main`,
...
export { TEST_SIDECAR_PORT, TEST_VITE_PORT, TEST_HOME };
