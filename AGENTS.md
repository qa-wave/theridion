...
02c329a Update AGENTS.md: orientation block + status snapshot for CLI handoff
b641c81 Add AGENTS.md — project context for future Codex sessions
...
✅ AGENTS.md kontext pro další session
...
- Pluginový systém — Bruno/Insomnia ho mají, my můžeme přidat až po
  Sprint 4.
- AI assistant — atraktivní (Postbot ekvivalent přes Codex API), ale
  neprioritní před credibility features.

---

Pokud potřebuješ tenhle dokument upravit, edituj přímo `AGENTS.md`
v rootu repa a commitni jako "Update AGENTS.md: …". Nepřidávej
